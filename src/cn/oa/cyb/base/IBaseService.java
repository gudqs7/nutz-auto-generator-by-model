...
public interface IBaseService<T> {
     ...
     * @throws Exception 异常外抛
     */
    Page<T> findAll(Page<T> page) throws Exception;
     ...
     * @throws Exception 异常外抛
     */
    List<T> findAll(String querySqlId) throws Exception;
     ...
     * @throws Exception 异常外抛
     */
    Page<T> findAll(String querySqlId, String countSqlId, Page<T> page) throws Exception;
     ...
     * @return 查询结果
     */
    Page<T> findAll(ParamVo<T> paramVo);
     ...
     * @return 查询结果
     */
    Page<T> findAll(String querySqlId, String countSqlId, ParamVo<T> paramVo);

    /**
     * 查询 paramVo sql id 方式(带自定义条件)
     *
     * @param querySqlId 查询 sql id
     * @param countSqlId 总数 sql id
     * @param paramVo    分页及条件对象
